function [rho,lambda,lmax,lmin] = wishart(Q,pvar),
% WISHART Find the analytic expected density of eigenvalues  
%
% [RHO,L,LMAX,LMIN]=WISHART(Q,PVAR) RHO(L) is found from the 
