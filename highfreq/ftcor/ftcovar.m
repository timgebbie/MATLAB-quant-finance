function varout = ftcovar(varargin)
% FTCOVAR calculates the covariance of two processes
%
% CORR = FTCOVAR(p1,p2,N,nrfc,n0)
%
...
% 
% FTCOVAR(p1,p2,N,nrfc,n0) calculates the covariance between two processes 
...
varout = (pi^2/(nrfc + 1 - n0))*(sum(fca(1,n0:nrfc).*fca(2,n0:nrfc)) + sum(fcb(1,n0:nrfc).*fcb(2,n0:nrfc)));
